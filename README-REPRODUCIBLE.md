...
Version **0.7.1** (versionCode 8):

```
app-release-unsigned.apk
SHA-256  416179406557aa482c95abf6e646bc63f27445741423afdb409649b7f72b5103
```
...
The signed v0.7.1 APK you download has SHA-256
`df7d5ec8a22f18a01e4cb8a0bac32a8d4cf8d3133497420b9ef06c9f52548b71`; the reproducible
unsigned build (§5) is `41617940…`, and `apksigcopier` (§6) confirms the signed APK is
...
Distributed via
[GitHub Releases](https://github.com/Kilombino/pyblock-watch/releases/tag/v0.7.1) and
Zapstore.

...
SHA-256  99735a5626ded277638672ae92d39b8e5fdb2bbab9e6a9605064c9c690c40325
```
...
The signed v0.7.6 APK you download has SHA-256
`0d0f39e7ed1d41ff58ef45e94fffd76f4951ff5472de15df80de7778cf37cf37`; the reproducible
unsigned build (§5) is `99735a56…`, and `apksigcopier` (§6) confirms the signed APK is
...
Distributed via
[GitHub Releases](https://github.com/Kilombino/pyblock-watch/releases/tag/v0.7.6) and
Zapstore.

...
Version **0.8.1** (versionCode 17):

```
app-release-unsigned.apk
SHA-256  2b49d1b48c2a166cfc8e0f79f99106e147d79b7198815e4e6bf921fa2a8db7ea
```
...
The signed v0.8.1 APK you download has SHA-256
`a1d4cf9f475f73104617b802171b6806df71d8db92146c7778ae6d94c2ca6502`; the reproducible
unsigned build (§5) is `2b49d1b4…`, and `apksigcopier` (§6) confirms the signed APK is
...
Distributed via
[GitHub Releases](https://github.com/Kilombino/pyblock-watch/releases/tag/v0.8.1) and
Zapstore.
